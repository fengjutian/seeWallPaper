...
//   new Vue({data:{versions:{electron:process.versions.electron,electronWebpack:require('electron-webpack/package.json').version}},
...
import './index.css';
import App from './views/components/mainPage/MainPage.js';
